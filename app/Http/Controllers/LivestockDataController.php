...
class LivestockDataController extends Controller
{
    ...
    public function store(Request $request, $nfc_uuid, $temperature, $humidity, $pulse_rate, $loc_latitude, $loc_longitude){
        ...
        if($livestockData != null){
            ...
            $phone = "08135439547";
            $message = "Livestock Data: " . $nfc_uuid . ", " . $temperature . "degCel., " . $humidity . "g/m^3, " . $pulse_rate . "bpm; Location on map: https://www.google.com/maps/search/?api=1&query=" . $loc_latitude. "," . $loc_longitude . "&query_place_id=ChIJDWlWr43EQhARIGWERwJtADoE";
            $this->sendToPhone($phone, $message);
